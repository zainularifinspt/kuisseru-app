...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans text-slate-50">
      ...
      <div className="text-center max-w-lg w-full bg-[#111827]/80 backdrop-blur-2xl p-8 sm:p-10 rounded-[32px] shadow-[0_0_40px_rgba(59,130,246,0.3)] border border-white/10 relative z-10">
        <div className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-blue-900/50 to-purple-900/50 rounded-[2rem] shadow-[0_0_20px_rgba(99,102,241,0.5)] mb-6 border border-blue-400/20 relative group overflow-hidden">
        ...
        <p className="text-slate-300 mb-8 text-base sm:text-lg font-light leading-relaxed">
          Bangkitkan antusiasme belajar siswa melalui pengalaman kuis interaktif yang cerdas dan real-time.
        </p>
        
        <div className="space-y-6">
          <form onSubmit={handleJoin} className="bg-[#0f172a]/60 p-4 rounded-2xl border border-white/10 shadow-inner flex flex-col gap-3">
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-slate-600 rounded-xl leading-5 bg-[#1e293b] text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm font-bold tracking-widest text-center transition-all shadow-inner"
                  required
                />
              </div>
              <Button type="submit" disabled={isLoading || joinCode.length !== 6} className="h-[50px] w-full sm:w-auto bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-xl shadow-[0_0_15px_rgba(6,182,212,0.4)] transition-all">
          ...
          <Link href="/teacher" className="block">
            <Button size="lg" className="w-full rounded-xl text-lg font-bold bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 border-0 h-[56px] shadow-[0_0_20px_rgba(59,130,246,0.5)] transition-all hover:scale-[1.03] active:scale-[0.98] group relative overflow-hidden text-white">
          ...
          <div className="text-xs sm:text-sm text-slate-400 font-medium flex items-center justify-center gap-2 pt-2">
